...
fun IncomeScreen(
    ...
    val originalAmountRequester = remember { BringIntoViewRequester() }

    val snackbarHostState = remember { SnackbarHostState() }
    val focusManager = LocalFocusManager.current

    LaunchedEffect(
        uiState.shouldScrollToAmount,
        uiState.shouldScrollToOriginalAmount
    ) {
        when {
            uiState.shouldScrollToAmount -> {
                amountReceivedRequester.bringIntoView()
                viewModel.clearScrollRequests()
            }

            uiState.shouldScrollToOriginalAmount -> {
                originalAmountRequester.bringIntoView()
                viewModel.clearScrollRequests()
            }
        }
    }
    ...
    Scaffold(
        ...
        ScreenContainer(
            ...
            Column(
                ...
                ScreenTitleWithIcon(
                    title = "Add Income",
                    subtitle = "Record income from salary, freelance, online, or crypto sources",
                ...
                Card(
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            modifier = Modifier
                                .fillMaxWidth()
                                .bringIntoViewRequester(amountReceivedRequester),
                            singleLine = true,
                        ...
                        Text(
                            text = "Optional: Add original currency details if income is in another currency.",
                            fontSize = 14.sp,
                        ...
                        OutlinedTextField(
                            ...
                            modifier = Modifier
                                .fillMaxWidth()
                                .bringIntoViewRequester(originalAmountRequester),
                            singleLine = true,
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text("Note") },
                            placeholder = { Text("Example: Salary with bonus") },
                            leadingIcon = {
                                Icon(
